...
namespace DemoADONET2023
{
    public partial class UpdateProduct : Form
    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlConnection conn = new SqlConnection("Data Source=DESKTOP-KFV30AR\\SQLEXPRESS;Initial Catalog=empresa;User ID=sa;Password=j0hiacii");
        ...
        {
            SqlConnection con = new SqlConnection("server=DESKTOP-KFV30AR\\SQLEXPRESS; database=empresa; Integrated Security = True;");
